  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="" class="brand-link">
        <img src="{{ secure_asset('dist/img/logo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" >
        <span class="brand-text font-weight-light">Techno Shark</span>
      </a>
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; 2018-2022 <a href="">TechnoShark.com</a>.</strong>
      All rights reserved.
