...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-dark shadow-sm">
            <div class="container">
                <img src="{{ secure_asset('dist/img/logo.png') }}" alt="" width="60">
                <a class="navbar-brand ml-2" href="{{ url('/') }}">
                    {{ config('app.name', 'Techno Shark') }}
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('home.nosotros') }}">{{ __('Nosotros') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('home.contactanos') }}">{{ __('Contáctanos') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('home.integrantes') }}">{{ __('Integrantes') }}</a>
                        </li>
                    </ul>
