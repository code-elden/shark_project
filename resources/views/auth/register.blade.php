            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register.user') }}">
                        ...
                        <div class="row mb-3">
                            <label for="dni" class="col-md-4 col-form-label text-md-right">{{ __('Nro. Documento de Identidad') }} <b class="text-danger">*</b></label>
                        ...
                        <div class="row mb-3">
                            <label for="nombres" class="col-md-4 col-form-label text-md-right">{{ __('Nombres') }} <b class="text-danger">*</b></label>
                        ...
                        <div class="row mb-3">
                            <label for="apellidos" class="col-md-4 col-form-label text-md-right">{{ __('Apellidos') }} <b class="text-danger">*</b></label>
                        ...
                        <div class="row mb-3">
                            <label for="direccion" class="col-md-4 col-form-label text-md-right">{{ __('Dirección') }} <b class="text-danger">*</b></label>
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('Correo Electrónico') }} <b class="text-danger">*</b></label>
