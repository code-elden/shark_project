...
class CategoriaController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if($id == 1){
            return back()->with('error', 'No puedes modificar el categoria Administrador');
        }
        ...
        try {
            ...
            return redirect()->route('categorias')->with('success', 'Categoria actualizado correctamente');
        } catch (\Throwable $th) {
            return back()->with('error', $th->getMessage());
        }
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            $categoria->delete();
            return redirect()->route('categorias')->with('success', 'Categoria eliminado correctamente');
        } catch (\Throwable $th) {
